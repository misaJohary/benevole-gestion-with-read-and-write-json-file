...
class Benevole {
  ...
  Benevole(this._name, this._number, this._email, this._adresse,
      this._profession, this._availability);

  Benevole.withId(this._id, this._name, this._number, this._email,
      this._adresse, this._profession, this._availability);
...
// class BenevoleProvider with ChangeNotifier {
//   DatabaseHelper databaseHelper = DatabaseHelper();
//   List<Benevole> _benevoleList;

//   List<Benevole> updateListView() {
//     final Future<Database> dbFuture = databaseHelper.initializeDatabase();
//     dbFuture.then((database) {
//       Future<List<Benevole>> benevoleListFuture =
//           databaseHelper.getBenevoleList();
//       benevoleListFuture.then((benevoles) {
//         if (benevoleList == null) {
//           _benevoleList = benevoles;
//           return _benevoleList;
//         }
//         return _benevoleList;
//       });
//     });
...
//   List<Benevole> get benevoleList => _benevoleList;
